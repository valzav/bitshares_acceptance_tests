...
Scenario: Alice shorts BitUSD and sells to Bob, then Bob shorts and Alice covers
  ...
  And Bob submits ask to sell 10000 XTS at 0.01 USD/XTS
  And I wait for 2 blocks
  Then Bob should have 100 USD
  And I should have 80000 XTS minus fee
  And I should spot the following USD/XTS market order:
  ...
  And I wait for 2 blocks
  Then I should have 68000 XTS minus 2*fee
  And I should have 120 USD
  And Bob should have 50000 XTS minus 2*fee
